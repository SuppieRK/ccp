...
| Agent integrations | `aider`, `antigravity`, `amazon-q`, `cline`, `claude`, `codex`, `continue`, `cursor`, `gemini`, `github-copilot`, `kiro`, `kilocode`, `opencode`, `qwen`, `roocode`, `trae`, `windsurf` |
